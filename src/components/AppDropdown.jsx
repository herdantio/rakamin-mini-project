...
export default function AppDropdown({id, todoId, position}) {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className="flex items-center rounded-full bg-gray-100 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100">
      ...
      >
        <Menu.Items className="absolute left-0 z-10 mt-2 w-[320px] origin-top-right rounded-md bg-white shadow-lg ">
          <div className="space-y-3 py-[14px] px-4">
            ...
            <Menu.Item className="text-sm font-semibold hover:text-rk-red flex flex-row space-x-5">
                <a onClick={
                  showDeleteModal
                  }>
                    <span>
